...
namespace Com.Nightonke.Boommenu {
	...
	public partial interface IOnBoomListener : IJavaObject {
		...
		[Register ("onBackgroundClick", "()V", "GetOnBackgroundClickHandler:Com.Nightonke.Boommenu.IOnBoomListenerInvoker, Binding_Boommenu-211")]
		...
		[Register ("onBoomDidHide", "()V", "GetOnBoomDidHideHandler:Com.Nightonke.Boommenu.IOnBoomListenerInvoker, Binding_Boommenu-211")]
		void OnBoomDidHide ();
		...
		[Register ("onBoomDidShow", "()V", "GetOnBoomDidShowHandler:Com.Nightonke.Boommenu.IOnBoomListenerInvoker, Binding_Boommenu-211")]
		void OnBoomDidShow ();
		...
		[Register ("onBoomWillHide", "()V", "GetOnBoomWillHideHandler:Com.Nightonke.Boommenu.IOnBoomListenerInvoker, Binding_Boommenu-211")]
		void OnBoomWillHide ();
		...
		[Register ("onBoomWillShow", "()V", "GetOnBoomWillShowHandler:Com.Nightonke.Boommenu.IOnBoomListenerInvoker, Binding_Boommenu-211")]
		void OnBoomWillShow ();
		...
		[Register ("onClicked", "(ILcom/nightonke/boommenu/BoomButtons/BoomButton;)V", "GetOnClicked_ILcom_nightonke_boommenu_BoomButtons_BoomButton_Handler:Com.Nightonke.Boommenu.IOnBoomListenerInvoker, Binding_Boommenu-211")]
	...
	internal class IOnBoomListenerInvoker : global::Java.Lang.Object, IOnBoomListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/nightonke/boommenu/OnBoomListener", typeof (IOnBoomListenerInvoker));
