...
namespace Com.Nightonke.Boommenu.BoomButtons {
	...
	public partial class TextInsideCircleButton : global::Com.Nightonke.Boommenu.BoomButtons.BoomButton {
		...
		public partial class Builder : global::Com.Nightonke.Boommenu.BoomButtons.BoomButtonWithTextBuilder {
			...
			internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder", typeof (Builder));
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/constructor[@name='TextInsideCircleButton.Builder' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
			...
			{
				global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder __this = global::Java.Lang.Object.GetObject<global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.ButtonRadius;
			}
#pragma warning restore 0169

			public virtual unsafe int ButtonRadius {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/method[@name='getButtonRadius' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/method[@name='build' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
			[Register ("build", "(Landroid/content/Context;)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton;", "GetBuild_Landroid_content_Context_Handler")]
			public override unsafe global::Com.Nightonke.Boommenu.BoomButtons.BoomButton Build (global::Android.Content.Context p0)
			{
				const string __id = "build.(Landroid/content/Context;)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton;";
				try {
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/method[@name='buttonCornerRadius' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("buttonCornerRadius", "(I)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;", "GetButtonCornerRadius_IHandler")]
			public virtual unsafe global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder ButtonCornerRadius (int p0)
			{
				const string __id = "buttonCornerRadius.(I)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (p0);
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
					return global::Java.Lang.Object.GetObject<global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/method[@name='buttonRadius' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("buttonRadius", "(I)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;", "GetInvokeButtonRadius_IHandler")]
			public virtual unsafe global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder InvokeButtonRadius (int p0)
			{
				const string __id = "buttonRadius.(I)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (p0);
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/method[@name='isRound' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Register ("isRound", "(Z)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;", "GetIsRound_ZHandler")]
			public virtual unsafe global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder IsRound (bool p0)
			{
				const string __id = "isRound.(Z)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (p0);
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.nightonke.boommenu.BoomButtons']/class[@name='TextInsideCircleButton.Builder']/method[@name='rotateText' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Register ("rotateText", "(Z)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;", "GetRotateText_ZHandler")]
			public virtual unsafe global::Com.Nightonke.Boommenu.BoomButtons.TextInsideCircleButton.Builder RotateText (bool p0)
			{
				const string __id = "rotateText.(Z)Lcom/nightonke/boommenu/BoomButtons/TextInsideCircleButton$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (p0);
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/nightonke/boommenu/BoomButtons/TextInsideCircleButton", typeof (TextInsideCircleButton));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
