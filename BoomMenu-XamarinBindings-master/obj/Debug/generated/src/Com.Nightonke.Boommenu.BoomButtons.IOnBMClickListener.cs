...
namespace Com.Nightonke.Boommenu.BoomButtons {
	...
	public partial interface IOnBMClickListener : IJavaObject {
		...
		[Register ("onBoomButtonClick", "(I)V", "GetOnBoomButtonClick_IHandler:Com.Nightonke.Boommenu.BoomButtons.IOnBMClickListenerInvoker, Binding_Boommenu-211")]
	...
	internal class IOnBMClickListenerInvoker : global::Java.Lang.Object, IOnBMClickListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/nightonke/boommenu/BoomButtons/OnBMClickListener", typeof (IOnBMClickListenerInvoker));
