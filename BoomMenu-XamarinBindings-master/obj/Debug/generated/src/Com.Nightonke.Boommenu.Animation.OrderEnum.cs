...
namespace Com.Nightonke.Boommenu.Animation {
	...
	public sealed partial class OrderEnum : global::Java.Lang.Enum {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/nightonke/boommenu/Animation/OrderEnum", typeof (OrderEnum));
		...
		public static unsafe global::Com.Nightonke.Boommenu.Animation.OrderEnum GetEnum (int p0)
		{
		...
		public static unsafe global::Com.Nightonke.Boommenu.Animation.OrderEnum ValueOf (string p0)
		{
